/**
 * @file hal_ble_scanner_mock.c
 * @brief Mock implementation of HAL BLE Scanner for host-based testing.
 *
 * Provides a controllable mock that implements the hal_ble_scanner.h
